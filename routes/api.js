...
router.post("/store_rating", async(req, res) =>{
    ...
    router.post("/push_notification", async(req, res) =>{//get_location
        ...
        try {
            ...
            if(existrating.rows[0].exists)
            {
                ...
                var query2=`select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating from business_image bi ,(select * from ( SELECT  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating,( 3959 * acos( cos( radians(`+latitude+`) ) * cos( radians( latitude ) ) * cos( radians( longitude ) - radians(`+longitude+`) ) + sin( radians(`+latitude+`) ) * sin( radians( latitude ) ) ) ) AS distance  FROM business ) al where distance < 700000 ORDER BY distance desc ) as b3 where bi.business_id=b3.bb_id and type=1 limit 10;`
    ...
    router.post("/get_10business_withuserid", async(req, res) =>{//get_location
        try {
            ...
            // var query = `select business_id,image_url,business_name,rating,business_rating from rating r, (select business_id bi_business_id,image_url,business_name,rating business_rating from business_image bi ,(select name business_name,business_id bb_id,rating from business as b ,(select business_id b_id,distance from location_business as lb ,(select * from ( SELECT  location_id l_id ,name lname,( 3959 * acos( cos( radians(`+latitude+`) ) * cos( radians( latitude ) ) * cos( radians( longitude ) - radians(`+longitude+`) ) + sin( radians(`+latitude+`) ) * sin( radians( latitude ) ) ) ) AS distance  FROM location ) al where distance < 700000 ORDER BY distance desc ) as s where lb.location_id=s.l_id) as sb where b.business_id=sb.b_id order by distance limit 10) as b3 where bi.business_id=b3.bb_id) bimage where r.business_id=bimage.bi_business_id;`
            var query =`select exists (select business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating,business_rating from rating r, (select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating from business_image bi ,(select  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating  FROM business b ,(select business_id f_bid from favorites where users_id=`+users_id+`) as f where b.business_id=f.f_bid)  as b3 where bi.business_id=b3.bb_id type=1) bimage where r.business_id=bimage.bi_business_id limit 10);`
            console.log(query);
            const existrating = await pool.query(query);
            console.log(existrating.rows[0].exists);
            if(existrating.rows[0].exists)
            {
                var query2=`select business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating,business_rating from rating r, (select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating from business_image bi ,(select  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating  FROM business b ,(select business_id f_bid from favorites where users_id=`+users_id+`) as f where b.business_id=f.f_bid)  as b3 where bi.business_id=b3.bb_id and type=1) bimage where r.business_id=bimage.bi_business_id limit 10;`
                const existrating2=await pool.query(query2);
                res.json({"status": 1, "data": existrating2.rows}); 
            }
                // res.json({"status": 1, "data": existrating.rows});  
            else{
                var query2=`select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating from business_image bi ,(select  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating  FROM business b ,(select business_id f_bid from favorites where users_id=`+users_id+`) as f where b.business_id=f.f_bid)  as b3 where bi.business_id=b3.bb_id and type=1 limit 10`
                const notexistrating=await pool.query(query2);
                res.json({"status": 1, "data": notexistrating.rows}); 
            }
        } catch (err) {
    ...
    router.post("/get_businessdetails", async(req, res) =>{//get_location
        try {
            const {business_id ,latitude ,longitude}  = req.body//'2';
            // const latitude ='25.333333333333333'
            // const longitude = '51.3333333333333'
            // const users_id=req.body
            // var query = `select business_id,image_url,business_name,rating,business_rating from rating r, (select business_id bi_business_id,image_url,business_name,rating business_rating from business_image bi ,(select name business_name,business_id bb_id,rating from business as b ,(select business_id b_id,distance from location_business as lb ,(select * from ( SELECT  location_id l_id ,name lname,( 3959 * acos( cos( radians(`+latitude+`) ) * cos( radians( latitude ) ) * cos( radians( longitude ) - radians(`+longitude+`) ) + sin( radians(`+latitude+`) ) * sin( radians( latitude ) ) ) ) AS distance  FROM location ) al where distance < 700000 ORDER BY distance desc ) as s where lb.location_id=s.l_id) as sb where b.business_id=sb.b_id order by distance limit 10) as b3 where bi.business_id=b3.bb_id) bimage where r.business_id=bimage.bi_business_id;`
            var query =`select exists (select business_id bi_business_id,image_url,type,business_name,arabic_business_name,sub_name,arabic_sub_name,rating , business_rating,distance,is_active,description,arabic_description,address,arabic_address,latitude,longitude,phone_number,alt_phone_number,email,slug,web,social_media,timing,service_name,arabic_service_name from rating r,( select business_id bi_business_id,image_url,type,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,distance,is_active,description,arabic_description,address,arabic_address,latitude,longitude,phone_number,alt_phone_number,email,slug,web,social_media,timing,service_name,arabic_service_name from business_image bi ,(select * from ( SELECT  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating,( 3959 * acos( cos( radians(`+latitude+`) ) * cos( radians( latitude ) ) * cos( radians( longitude ) - radians(`+longitude+`) ) + sin( radians(`+latitude+`) ) * sin( radians( latitude ) ) ) ) AS distance,is_active,description,arabic_description,address,arabic_address,latitude,longitude,phone_number,alt_phone_number,email,slug,web,social_media,timing,service_name,arabic_service_name  FROM business where business_id=`+business_id+`) al where distance < 700000 ORDER BY distance desc ) as b3 where bi.business_id=b3.bb_id) bb where r.business_id=bb.bi_business_id;);`
            console.log(query);
            const existrating = await pool.query(query);
            console.log(existrating.rows[0].exists);
            if(existrating.rows[0].exists)
            {
                var query2=`select business_id bi_business_id,image_url,type,business_name,arabic_business_name,sub_name,arabic_sub_name,rating, business_rating,distance,is_active,description,arabic_description,address,arabic_address,latitude,longitude,phone_number,alt_phone_number,email,slug,web,social_media,timing,service_name,arabic_service_name from rating r,( select business_id bi_business_id,image_url,type,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,distance,is_active,description,arabic_description,address,arabic_address,latitude,longitude,phone_number,alt_phone_number,email,slug,web,social_media,timing,service_name,arabic_service_name from business_image bi ,(select * from ( SELECT  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating,( 3959 * acos( cos( radians(`+latitude+`) ) * cos( radians( latitude ) ) * cos( radians( longitude ) - radians(`+longitude+`) ) + sin( radians(`+latitude+`) ) * sin( radians( latitude ) ) ) ) AS distance,is_active,description,arabic_description,address,arabic_address,latitude,longitude,phone_number,alt_phone_number,email,slug,web,social_media,timing,service_name,arabic_service_name  FROM business where business_id=`+business_id+`) al where distance < 700000 ORDER BY distance desc ) as b3 where bi.business_id=b3.bb_id) bb where r.business_id=bb.bi_business_id;`
                const existrating2=await pool.query(query2);
                res.json({"status": 1, "data": existrating2.rows}); 
            }
                // res.json({"status": 1, "data": existrating.rows});  
            else{
                var query2=` select business_id bi_business_id,image_url,type,business_name,arabic_business_name,sub_name,arabic_sub_name,rating, business_rating,distance,is_active,description,arabic_description,address,arabic_address,latitude,longitude,phone_number,alt_phone_number,email,slug,web,social_media,timing,service_name,arabic_service_name from business_image bi ,(select * from ( SELECT  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating,( 3959 * acos( cos( radians(`+latitude+`) ) * cos( radians( latitude ) ) * cos( radians( longitude ) - radians(`+longitude+`) ) + sin( radians(`+latitude+`) ) * sin( radians( latitude ) ) ) ) AS distance,is_active,description,arabic_description,address,arabic_address,latitude,longitude,phone_number,alt_phone_number,email,slug,web,social_media,timing,service_name,arabic_service_name  FROM business where business_id=`+business_id+`) al where distance < 700000 ORDER BY distance desc ) as b3 where bi.business_id=b3.bb_id`
                const notexistrating=await pool.query(query2);
                res.json({"status": 1, "data": notexistrating.rows}); 
            }
        } catch (err) {
    ...
    // select business_id bi_business_id,image_url,type,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,distance from rating r,( select business_id bi_business_id,image_url,type,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,distance from business_image bi ,(select * from ( SELECT  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating,( 3959 * acos( cos( radians(24.33) ) * cos( radians( latitude ) ) * cos( radians( longitude ) - radians(51.22) ) + sin( radians(24.33) ) * sin( radians( latitude ) ) ) ) AS distance  FROM business where business_id='2') al where distance < 700000 ORDER BY distance desc ) as b3 where bi.business_id=b3.bb_id) bb where r.business_id=bb.bi_business_id;
    ...
    router.post("/get_10business_sort", async(req, res) =>{//get_location
        try {
            ...
            else if(sort=='location' && sub_category_id!=='all' && location_id == 'all')
            {
                ...
                sortedbusiness = await getallalphabeticsortedbusinesswithlocationid(main_category_id,location_id)
            }
            else if(sort=='rating' && sub_category_id=='all' && location_id !== 'all'){
                sortedbusiness = await getallratingsortedbusinesswithlocationid(main_category_id,location_id)
            }
            else if(sort=='location' && sub_category_id=='all' && location_id !== 'all'){
                sortedbusiness = await getalllocationsortedbusinesswithlocationid(main_category_id,latitude,longitude)
            }
    ...
    async function getallsortedbusiness(main_category_id){
            var query =`select exists (select business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating,business_rating,phone_number,latitude,longitude from rating r, (select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude from business_image bi ,(select business_id bb_id ,name business_name,arabic_name arabic_business_name ,sub_name,arabic_sub_name,b_id,rating,phone_number,latitude,longitude from business b ,( select business_id b_id,mc_sub_id ,sub_category_id from sub_categories_business scb, ( select sub_category_id mc_sub_id from main_sub_categories msc,(select main_category_id main_category_id1 from main_category where main_category_id=`+main_category_id+`) mc where msc.main_category_id=mc.main_category_id1) ms where scb.sub_category_id=ms.mc_sub_id) m where b.business_id=m.b_id)  as b3 where bi.business_id=b3.bb_id and type=1) bimage where r.business_id=bimage.bi_business_id order by business_name asc limit 10);`
        ...
        if(existrating.rows[0].exists)
        {
            ...
            var query2=`select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude from business_image bi ,(select business_id bb_id ,name business_name,arabic_name arabic_business_name ,sub_name,arabic_sub_name,b_id,rating,phone_number,latitude,longitude from business b ,( select business_id b_id,mc_sub_id ,sub_category_id from sub_categories_business scb, ( select sub_category_id mc_sub_id from main_sub_categories msc,(select main_category_id main_category_id1 from main_category where main_category_id=`+main_category_id+`) mc where msc.main_category_id=mc.main_category_id1) ms where scb.sub_category_id=ms.mc_sub_id) m where b.business_id=m.b_id)  as b3 where bi.business_id=b3.bb_id and type=1 limit 10`
            const notexistrating=await pool.query(query2);
    ...
    async function getallratingsortedbusiness(main_category_id){
        ...
        if(existrating.rows[0].exists)
        {
            var query2=`select business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating,business_rating,phone_number,latitude,longitude from rating r, (select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude from business_image bi ,(select business_id bb_id ,name business_name,arabic_name arabic_business_name ,sub_name,arabic_sub_name,b_id,rating,phone_number,latitude,longitude from business b ,( select business_id b_id,mc_sub_id ,sub_category_id from sub_categories_business scb, ( select sub_category_id mc_sub_id from main_sub_categories msc,(select main_category_id main_category_id1 from main_category where main_category_id=`+main_category_id+`) mc where msc.main_category_id=mc.main_category_id1) ms where scb.sub_category_id=ms.mc_sub_id) m where b.business_id=m.b_id)  as b3 where bi.business_id=b3.bb_id and type=1) bimage where r.business_id=bimage.bi_business_id order by rating desc limit 10;`
            const existrating2=await pool.query(query2);
            return existrating2
            ...
            var query2=`select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude from business_image bi ,(select business_id bb_id ,name business_name,arabic_name arabic_business_name ,sub_name,arabic_sub_name,b_id,rating,phone_number,latitude,longitude from business b ,( select business_id b_id,mc_sub_id ,sub_category_id from sub_categories_business scb, ( select sub_category_id mc_sub_id from main_sub_categories msc,(select main_category_id main_category_id1 from main_category where main_category_id=`+main_category_id+`) mc where msc.main_category_id=mc.main_category_id1) ms where scb.sub_category_id=ms.mc_sub_id) m where b.business_id=m.b_id)  as b3 where bi.business_id=b3.bb_id and type=1 order by business_rating desc limit 10`
            const notexistrating=await pool.query(query2);
            return notexistrating
            // res.json({"status": 1, "data": notexistrating.rows}); 
        }
    ...
    async function getalllocationsortedbusiness(main_category_id,latitude,longitude){
        ...
        if(existrating.rows[0].exists)
        {
            ...
            var query2=`select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude,distance from business_image bi ,(select * from ( SELECT  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating,phone_number,latitude,longitude,( 3959 * acos( cos( radians(`+latitude+`) ) * cos( radians( latitude ) ) * cos( radians( longitude ) - radians(`+longitude+`) ) + sin( radians(`+latitude+`) ) * sin( radians( latitude ) ) ) ) AS distance  from business b ,( select business_id b_id,mc_sub_id ,sub_category_id from sub_categories_business scb, ( select sub_category_id mc_sub_id from main_sub_categories msc,(select main_category_id main_category_id1 from main_category where main_category_id=`+main_category_id+`) mc where msc.main_category_id=mc.main_category_id1) ms where scb.sub_category_id=ms.mc_sub_id) m where b.business_id=m.b_id ) al where distance < 700000 ) as b3 where bi.business_id=b3.bb_id and type=1 order by distance asc limit 10`
            const notexistrating=await pool.query(query2);
            return notexistrating
            // res.json({"status": 1, "data": notexistrating.rows}); 
        }
    ...
    async function getallsubcategoryalphabetsortfilterbusiness(sub_category_id){
        var query =`select exists (select business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating,business_rating,phone_number,latitude,longitude from rating r, (select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude from business_image bi ,(select business_id bb_id ,name business_name,arabic_name arabic_business_name ,sub_name,arabic_sub_name,b_id,rating,phone_number,latitude,longitude from business b ,( select business_id b_id ,sub_category_id from sub_categories_business  where  sub_category_id=`+sub_category_id+` ) m where b.business_id=m.b_id)  as b3 where bi.business_id=b3.bb_id and type=1) bimage where r.business_id=bimage.bi_business_id order by business_name asc limit 10);`
        ...
        if(existrating.rows[0].exists)
        {
            ...
            var query2=`select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude from business_image bi ,(select business_id bb_id ,name business_name,arabic_name arabic_business_name ,sub_name,arabic_sub_name,b_id,rating,phone_number,latitude,longitude from business b ,( select business_id b_id ,sub_category_id from sub_categories_business  where  sub_category_id=`+sub_category_id+` ) m where b.business_id=m.b_id)  as b3 where bi.business_id=b3.bb_id and type=1 order by business_name asc limit 10;`
            const notexistrating=await pool.query(query2);
            return notexistrating
            // res.json({"status": 1, "data": notexistrating.rows}); 
        }
    ...
    async function getallsubcategoryratingsortfilterbusiness(sub_category_id){
        var query =`select exists (select business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating,business_rating,phone_number,latitude,longitude from rating r, (select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude from business_image bi ,(select business_id bb_id ,name business_name,arabic_name arabic_business_name ,sub_name,arabic_sub_name,b_id,rating,phone_number,latitude,longitude from business b ,( select business_id b_id ,sub_category_id from sub_categories_business  where  sub_category_id=`+sub_category_id+` ) m where b.business_id=m.b_id)  as b3 where bi.business_id=b3.bb_id and type=1) bimage where r.business_id=bimage.bi_business_id order by rating desc limit 10);`
        ...
        if(existrating.rows[0].exists)
        {
            ...
            var query2=`select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude from business_image bi ,(select business_id bb_id ,name business_name,arabic_name arabic_business_name ,sub_name,arabic_sub_name,b_id,rating,phone_number,latitude,longitude from business b ,( select business_id b_id ,sub_category_id from sub_categories_business  where  sub_category_id=`+sub_category_id+` ) m where b.business_id=m.b_id)  as b3 where bi.business_id=b3.bb_id and type=1 order by business_rating desc limit 10;`
            const notexistrating=await pool.query(query2);
            return notexistrating
            // res.json({"status": 1, "data": notexistrating.rows}); 
        }
    ...
    async function getallsubcategoryfilterlocationsortedbusiness(main_category_id,latitude,longitude){
        var query =`select exists ( select business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating,business_rating,phone_number,latitude,longitude,distance from rating r, (select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude,distance from business_image bi ,(select * from ( SELECT  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating,phone_number,latitude,longitude,( 3959 * acos( cos( radians(23.4444) ) * cos( radians( latitude ) ) * cos( radians( longitude ) - radians(51.7777) ) + sin( radians(23.4444) ) * sin( radians( latitude ) ) ) ) AS distance  from business b ,( select business_id b_id,sub_category_id from sub_categories_business  where  sub_category_id='2' ) m where b.business_id=m.b_id ) al where distance < 700000 ) as b3 where bi.business_id=b3.bb_id and type=1) bimage where r.business_id=bimage.bi_business_id order by distance asc limit 10);`
        console.log(query);
        const existrating = await pool.query(query);
        console.log(existrating.rows[0].exists);
        if(existrating.rows[0].exists)
        {
            ...
            var query2=`select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude,distance from business_image bi ,(select * from ( SELECT  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating,phone_number,latitude,longitude,( 3959 * acos( cos( radians(23.4444) ) * cos( radians( latitude ) ) * cos( radians( longitude ) - radians(51.7777) ) + sin( radians(23.4444) ) * sin( radians( latitude ) ) ) ) AS distance  from business b ,( select business_id b_id,sub_category_id from sub_categories_business  where  sub_category_id='2' ) m where b.business_id=m.b_id ) al where distance < 700000 ) as b3 where bi.business_id=b3.bb_id and type=1 order by distance asc limit 10`
            const notexistrating=await pool.query(query2);
            return notexistrating
            // res.json({"status": 1, "data": notexistrating.rows}); 
        }
    }
    async function getallalphabeticsortedbusinesswithlocationid(main_category_id,location_id){
        var query =`select exists (select business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating,business_rating,phone_number,latitude,longitude from rating r, (select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude from business_image bi ,(select business_id bb_id ,name business_name,arabic_name arabic_business_name ,sub_name,arabic_sub_name,b_id,rating,phone_number,latitude,longitude from business b ,(    select business_id b_id ,location_id from location_business bl, ( select business_id bm_id,mc_sub_id ,sub_category_id from sub_categories_business scb, ( select sub_category_id mc_sub_id from main_sub_categories msc,(select main_category_id main_category_id1 from main_category where main_category_id=`+main_category_id+`) mc where msc.main_category_id=mc.main_category_id1) ms where scb.sub_category_id=ms.mc_sub_id)  prevm   where  bl.business_id=prevm.bm_id and location_id=`+location_id+`     ) m where b.business_id=m.b_id)  as b3 where bi.business_id=b3.bb_id and type=1) bimage where r.business_id=bimage.bi_business_id order by business_name asc limit 10);`
    ...
    if(existrating.rows[0].exists)
    {
        ...
        var query2=`select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude from business_image bi ,(select business_id bb_id ,name business_name,arabic_name arabic_business_name ,sub_name,arabic_sub_name,b_id,rating,phone_number,latitude,longitude from business b ,(    select business_id b_id ,location_id from location_business bl, ( select business_id bm_id,mc_sub_id ,sub_category_id from sub_categories_business scb, ( select sub_category_id mc_sub_id from main_sub_categories msc,(select main_category_id main_category_id1 from main_category where main_category_id=`+main_category_id+`) mc where msc.main_category_id=mc.main_category_id1) ms where scb.sub_category_id=ms.mc_sub_id)  prevm   where  bl.business_id=prevm.bm_id and location_id=`+location_id+`     ) m where b.business_id=m.b_id)  as b3 where bi.business_id=b3.bb_id and type=1 order by business_name asc limit 10`
        const notexistrating=await pool.query(query2);
        return notexistrating
        // res.json({"status": 1, "data": notexistrating.rows}); 
    }
}
async function getallratingsortedbusinesswithlocationid(main_category_id,location_id){
    var query =`select exists (select business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating,business_rating,phone_number,latitude,longitude from rating r, (select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude from business_image bi ,(select business_id bb_id ,name business_name,arabic_name arabic_business_name ,sub_name,arabic_sub_name,b_id,rating,phone_number,latitude,longitude from business b ,(    select business_id b_id ,location_id from location_business bl, ( select business_id bm_id,mc_sub_id ,sub_category_id from sub_categories_business scb, ( select sub_category_id mc_sub_id from main_sub_categories msc,(select main_category_id main_category_id1 from main_category where main_category_id=`+main_category_id+`) mc where msc.main_category_id=mc.main_category_id1) ms where scb.sub_category_id=ms.mc_sub_id)  prevm   where  bl.business_id=prevm.bm_id and location_id=`+location_id+`     ) m where b.business_id=m.b_id)  as b3 where bi.business_id=b3.bb_id and type=1) bimage where r.business_id=bimage.bi_business_id order by rating desc limit 10);`
...
if(existrating.rows[0].exists)
{
    ...
    var query2=`select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude from business_image bi ,(select business_id bb_id ,name business_name,arabic_name arabic_business_name ,sub_name,arabic_sub_name,b_id,rating,phone_number,latitude,longitude from business b ,(    select business_id b_id ,location_id from location_business bl, ( select business_id bm_id,mc_sub_id ,sub_category_id from sub_categories_business scb, ( select sub_category_id mc_sub_id from main_sub_categories msc,(select main_category_id main_category_id1 from main_category where main_category_id=`+main_category_id+`) mc where msc.main_category_id=mc.main_category_id1) ms where scb.sub_category_id=ms.mc_sub_id)  prevm   where  bl.business_id=prevm.bm_id and location_id=`+location_id+`     ) m where b.business_id=m.b_id)  as b3 where bi.business_id=b3.bb_id and type=1 order by business_rating desc limit 10`
    const notexistrating=await pool.query(query2);
    return notexistrating
    // res.json({"status": 1, "data": notexistrating.rows}); 
}
}
async function getalllocationsortedbusinesswithlocationid(main_category_id,latitude,longitude){
    var query =`select exists (select business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating,business_rating,phone_number,latitude,longitude,distance from rating r, (select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude,distance from business_image bi ,(select * from ( SELECT  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating,phone_number,latitude,longitude,( 3959 * acos( cos( radians(`+latitude+`) ) * cos( radians( latitude ) ) * cos( radians( longitude ) - radians(`+longitude+`) ) + sin( radians(`+latitude+`) ) * sin( radians( latitude ) ) ) ) AS distance  from business b ,(     select business_id b_id ,location_id from location_business bl, ( select business_id bm_id,mc_sub_id ,sub_category_id from sub_categories_business scb, ( select sub_category_id mc_sub_id from main_sub_categories msc,(select main_category_id main_category_id1 from main_category where main_category_id=`+main_category_id+`) mc where msc.main_category_id=mc.main_category_id1) ms where scb.sub_category_id=ms.mc_sub_id)  prevm   where  bl.business_id=prevm.bm_id and location_id='1' ) m where b.business_id=m.b_id ) al where distance < 700000 ) as b3 where bi.business_id=b3.bb_id and type=1) bimage where r.business_id=bimage.bi_business_id order by distance asc limit 10);`
    console.log(query);
    const existrating = await pool.query(query);
    console.log(existrating.rows[0].exists);
    if(existrating.rows[0].exists)
    {
        ...
        var query2=`select business_id bi_business_id,image_url,business_name,arabic_business_name,sub_name,arabic_sub_name,rating business_rating,phone_number,latitude,longitude,distance from business_image bi ,(select * from ( SELECT  business_id bb_id,name business_name,arabic_name arabic_business_name,sub_name,arabic_sub_name,rating,phone_number,latitude,longitude,( 3959 * acos( cos( radians(`+latitude+`) ) * cos( radians( latitude ) ) * cos( radians( longitude ) - radians(`+longitude+`) ) + sin( radians(`+latitude+`) ) * sin( radians( latitude ) ) ) ) AS distance  from business b ,(     select business_id b_id ,location_id from location_business bl, ( select business_id bm_id,mc_sub_id ,sub_category_id from sub_categories_business scb, ( select sub_category_id mc_sub_id from main_sub_categories msc,(select main_category_id main_category_id1 from main_category where main_category_id=`+main_category_id+`) mc where msc.main_category_id=mc.main_category_id1) ms where scb.sub_category_id=ms.mc_sub_id)  prevm   where  bl.business_id=prevm.bm_id and location_id='1' ) m where b.business_id=m.b_id ) al where distance < 700000 ) as b3 where bi.business_id=b3.bb_id and type=1 order by distance asc limit 10`
        const notexistrating=await pool.query(query2);
        return notexistrating
        // res.json({"status": 1, "data": notexistrating.rows}); 
    }
